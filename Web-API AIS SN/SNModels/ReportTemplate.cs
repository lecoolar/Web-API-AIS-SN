...
namespace Web_API_AIS_SN.SNModels
{
    public partial class ReportTemplate
    {
        ...
        {
            AccountTypeDocuments = new HashSet<AccountTypeDocument>();
        ...
        public virtual Faset FasetFilter { get; set; }
        public virtual ReportGroup ReportGroup { get; set; }
        public virtual ICollection<AccountTypeDocument> AccountTypeDocuments { get; set; }
