...
namespace Web_API_AIS_SN.SNModels
{
    public partial class Request1
    {
        public Request1()
        {
            InverseReverseRequest = new HashSet<Request1>();
            RequestAccountServiceDebtByPeriods = new HashSet<RequestAccountServiceDebtByPeriod>();
        ...
        public virtual Calc1 Calc { get; set; }
        ...
        public virtual FasetItem RequestTypeFaset { get; set; }
        public virtual Request1 ReverseRequest { get; set; }
        public virtual ICollection<Request1> InverseReverseRequest { get; set; }
        public virtual ICollection<RequestAccountServiceDebtByPeriod> RequestAccountServiceDebtByPeriods { get; set; }
