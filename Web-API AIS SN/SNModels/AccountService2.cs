...
{
    public partial class AccountService2
    {
        ...
        public decimal? InfoCalcValue { get; set; }
        public decimal RateCapacity { get; set; }
        public decimal? InfoCalcValue2 { get; set; }
        public decimal? InfoCalcValue3 { get; set; }
        public int? InfoCalcFasetId { get; set; }
        public decimal? SocialNormRate { get; set; }
        public decimal? BigRateForDay { get; set; }
        public decimal? AvgConsumptionForDay { get; set; }
        public decimal? InfoCalcValue4 { get; set; }

        public virtual FasetItem InfoCalcFaset { get; set; }
    }
}
